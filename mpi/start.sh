...
do 
    ...
    mkdir $dir
    mpirun -n 3 --oversubscribe MPI-matrix-gen $seed $dir $K $K $K
    if [ $K -le 2000 ]; then
    ...
    do
        ...
        do
            ...
            mpirun -n $p --oversubscribe MPI-prod-kobero $dir >> ../kobero-result/result-$K-$p
            echo "{}]}," >> ../kobero-result/result-$K-$p
        done
...
do
    ...
    mkdir $dir
    mpirun -n 3 --oversubscribe MPI-matrix-gen $seed $dir 15000 15000 $K
    mpirun -n 1 MPI-prod-kobero $dir > ../kobero-result/result-$K-1
    ...
    do
        ...
        do
            ...
            do
                ...
                mpirun -n $p --oversubscribe MPI-prod-fanfa $dir $kb $kb >> ../fanfa-result/result-$K-$kb-$p
                echo "{}]}," >> ../fanfa-result/result-$K-$kb-$p
            done
